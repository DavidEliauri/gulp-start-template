...
const path = {
    ...
    src: {
        ...
        css: `${src_folder}/style.css`,
        js: `${src_folder}/js/app.js`,
        assets: `${src_folder}/assets/**/*`,
    },
    watch: {
        html: `${src_folder}/**/*.html`,
        css: [`${src_folder}/style.css`, `${src_folder}/**/*.html`],
        js: `${src_folder}/js/**/*.js`,
        assets: `${src_folder}/assets/**/*`,
    },
...
const post_css_plugins = [require("tailwindcss"), require("autoprefixer")];

if (isBuild) {
    post_css_plugins.push(require("postcss-minify"));
}
...
const main_tasks = gulp.parallel(html, css, files, js);
